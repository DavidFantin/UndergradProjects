...
public class KThread {
	...
	public static void finish() {
		...
		// WAKE UP currentThread;

		///////// HAD TO CHANGE \\\\\\\\\
		KThread TMPThread;
		while ((TMPThread = currentThread.JQ.nextThread()) != null) {
			TMPThread.ready();
		}
	...
	public void join() {
		...
		// Because of this if statement: if B is finished, then Join() returns
		// immediately.
	...
	private static KThread A; // The thread calling B (Joiner)
	private static KThread B; // The thread being called by A (Joinee)
	public ThreadQueue JQ = ThreadedKernel.scheduler.newThreadQueue(true); // I had to remove the static modifier and
